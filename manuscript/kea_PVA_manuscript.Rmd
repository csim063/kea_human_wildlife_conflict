...
get_pkgs(c("tmap", "ggmap", "spData", "sf"))
...
# Data accessibility
All the data used as well as a reproducible notebook containing the scripts to recreate this paper, including all figures, are available at
